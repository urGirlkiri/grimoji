...
const Set<Song> menuSongs = {
  ...
  Song(
    'halloween_trap.m4a',
    'Halloween Trap',
    artist: 'Villatic Music from Pixabay',
  ),
  Song(
    'mystical_halloween.m4a',
    'Mystical Halloween',
    artist: 'Villatic Music from Pixabay',
  ),
  Song(
    'mysterious_halloween.m4a',
    'Mysterious Halloween',
    artist: 'TuneTank from Pixabay',
  ),
  Song('halloween.m4a', 'Halloween', artist: 'TuneTank from Pixabay'),
  Song(
    'halloween_bg.m4a',
    'Halloween Bg',
    artist: 'viacheslavstarostin from Pixabay',
  ),
};
...
const Set<Song> levelSongs = {
  ...
  Song(
    'halloween_scary.m4a',
    'Halloween Scary',
    artist: 'The Mountain from Pixabay',
  ),
  Song(
    'halloween_happy.m4a',
    'Halloween Happy Background',
    artist: 'Sigma Music Art from Pixabay',
  ),
  Song(
    'halloween_background.m4a',
