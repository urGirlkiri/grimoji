...
class GameState extends ChangeNotifier {
  ...
  final VoidCallback onComboFinished;
  ...
  Future<void> resolveSwipe(TileCoordinate draggedCoordinate, TileCoordinate targetCoordinate) async {
    isProcessing = true; 
    notifyListeners();

    final TileCoordinate originalD = TileCoordinate(row: draggedCoordinate.row, col: draggedCoordinate.col);
    final TileCoordinate originalT = TileCoordinate(row: targetCoordinate.row, col: targetCoordinate.col);
    ...
    while (hasCombos) {
      ...
      gameController.spawnTiles(matches, this, mergePoint: isFirstMatch ? targetCoordinate : null); 
