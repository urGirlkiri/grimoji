...
class _PowerupBump extends StatefulWidget {
  final ValueNotifier<int> token;
  final Widget child;

  const _PowerupBump({required this.token, required this.child});

  @override
  State<_PowerupBump> createState() => _PowerupBumpState();
}

class _PowerupBumpState extends State<_PowerupBump>
