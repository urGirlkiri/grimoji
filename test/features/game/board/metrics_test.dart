  ...
  group('BoardMetrics Tests', () {
    ...
    test('Should start in an unready state with null values', () {
      expect(
        metrics.isReady,
        isFalse,
        reason: 'A fresh BoardMetrics should not be ready',
      );
    ...
    test(
      'updateMetrics should correctly assign all dimensions and mark as ready',
      () {
        ...
        expect(
          metrics.isReady,
          isTrue,
          reason: 'After receiving data, it must be ready',
        );
    ...
    test('updateMetrics MUST trigger notifyListeners()', () {
      ...
      expect(
        ...
        isTrue,
        reason:
            'If notifyListeners is skipped, the UI will never draw the board',
      );
    });
  });
}
